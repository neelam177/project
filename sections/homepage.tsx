...
const Home = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      color: "#0E5A17",
      paragraph: "We pledge to conserve water, a precious and finite resource.",
      points: [
      ...
      <div className="px-[100px] py-[20px] bg-[#FFF7F8]">
        <div className="flex justify-between relative ">
          <div className="top-[32px]">
            <span
              className={` text-[70px] tracking-[-0.4px] text-[#D17710] font-normal  font ${nunito.className}`}
            >
              Sustainability
            </span>
            <br />
            <span
              className={` text-[40px] tracking-[-0.4px]  font-normal font text-[#0E5A17] ${nunito.className}`}
            >
              Pledge
            </span>
          </div>
        ...
        <div className="text-[#F5BF81] border-[1px] opacity-50 max-w-[982px] mt-9.5"></div>
        <div className=" w-full ">
          <div className="py-[80px]">
            <h1
              className={`text-[#F5BF81] text-[50px] font ${nunito.className}`}
            >
              Our Commitment to <br />
              <span
                className={`text-[#0E5A17] text-[50px] font-bold font ${nunito.className}`}
              >
                Purpose, Planet,
              </span>
              <span
                className={`text-[#0E5A17] text-[50px] font-normal font ${nunito.className}`}
              >
                {" "}
                and
              </span>
            ...
            <h1
              className={` text-[22px] font-normal tracking-[-0.4px]  ${nunito.className}`}
            >
              At
              <span
              ...
              how we innovate, operate, and lead. As Merilians, we pledge to
              embed sustainable actions into our everyday choices to create
              meaningful impact across our organization and the communities we
              serve.
            </h1>
          </div>
        </div>
        ...
        <div className="pt-[40px] grid  grid-cols-5  gap-4 relative">
          {data.map((item, index) => (
            ...
            >
              <h1
                className={`font ${inter.className} font-medium text-[22px] `}
              >
                {item.title} <br />
                <span
                  className={`font ${inter.className} font-medium text-[22px] text-[#0E5A17] `}
                >
                  {item.subtitle}
                </span>
              </h1>
              ...
              <p
                className={`font ${inter.className} font-normal text-[15px] text-[#616161]  pt-[15px] pb-[10px]`}
              >
                {item.paragraph}
              </p>
              <ul
                className={`font ${inter.className} font-normal text-[14px] text-[#616161] list-disc pl-6 space-y-3 `}
              >
        ...
        <div className="flex pt-[50px]">
          ...
          >
            By taking this pledge, I affirm my role as a sustainability
            ambassador at Meril. Together, through collective action and
            continuous learning, we will contribute to a healthier planet and a
        ...
        <div className="pl-[90px] pb-[94px]">
          <div className="pt-[50px]">
            <div className="border-[1px] rounded-[40px] pb-[30px] text-[#F5BF81] h-[690px]">
              <h1
                className={`text-[70px] text-[#D17710] p-[25px] font-normal font ${nunito.className}`}
              >
                Share Your{" "}
                <span className="text-[#0E5A17] text-[70px]">Selfie</span>
              </h1>
              <form className="px-[30px]" onSubmit={handleSubmit}>
                <div className=" pt-[20px] flex flex-col gap-[10px]">
                  <label
                    className={`font ${nunito.className} font-medium text-[25px] text-[#D17710] `}
                  >
                    Your Name:
                  </label>
                  <input
                ...
                <div className=" pt-[40px]">
                  <label
                    className={`font ${nunito.className}  gap-[10px] font-medium text-[25px] text-[#D17710] `}
                  >
                    Upload Your Image:
                  </label>
